   ...
   /////////////////////////////////////////////////////////////////////
    ...
    public function fix_targets()  {
        ...
        $this->bodycontent .= ''
            ...
            ."  items = document.getElementsByClassName('activity-header')\n"
            ."  for (const element of items) { element.style.display = 'none'}\n"
            ."  items = document.getElementsByClassName('secondary-navigation')\n"
            ."  for (const element of items) { element.style.display = 'none'}\n"
            ."}\n"
            ."HP_add_listener(window, 'load', display_override);\n"
            .'//]]>'."\n"
            .'</script>'."\n"
        ;
    }
